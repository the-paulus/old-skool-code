...
**
** Created: Thu Oct 19 23:16:57 2000
...
void ElementQuizView::staticMetaObject()
{
    ...
    m1_t0 v1_0 = &ElementQuizView::slotNext;
    m1_t1 v1_1 = &ElementQuizView::slotShowAnswer;
    QMetaData *slot_tbl = new QMetaData[2];
    slot_tbl[0].name = "slotNext()";
    slot_tbl[1].name = "slotShowAnswer()";
