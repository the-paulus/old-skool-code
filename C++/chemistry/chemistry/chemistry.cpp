...
void Chemistry::initDoc()
{
   doc=new ChemistryDoc();
}

void Chemistry::initView()
{ 
  ////////////////////////////////////////////////////////////////////
  // set the main widget here
  view=new ChemistryView(this, doc);
  setCentralWidget(view);
}

bool Chemistry::queryExit()
{
...
void Chemistry::slotViewToolBar()
{
...
void Chemistry::slotViewStatusBar()
{
...
void Chemistry::slotHelpAbout()
{
  QMessageBox::about(this,"About...",
                     IDS_APP_ABOUT );
}

void Chemistry::slotStatusHelpMsg(const QString &text)
{
  ///////////////////////////////////////////////////////////////////
...
void Chemistry::statusCallback(int id_)
{
  switch (id_)
  {
    case ID_FILE_NEW:
