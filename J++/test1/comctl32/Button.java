...
/** @com.class(classid=0713F354-850A-101B-AFC0-4210102A8DA7,DynamicCasts) 
    @com.interface(iid=7791BA42-E020-11CF-8E74-00A0C90F26F8, thread=AUTO, type=DUAL) */
public class Button implements IUnknown,com.ms.com.NoAutoScripting,comctl32.IButton
{
  ...
  /** @com.method(vtoffset=5, dispid=0, type=PROPPUT, name="_ObjectDefault", name2="put_ObjectDefault", addFlagsVtable=4)
      ...
      @hidden */
  public native void set_ObjectDefault(String pbstr_ObjectDefault);
  ...
  public native void setValue(int psValue);
  ...
  public native void setDescription(String pbstrDescription);
  ...
  /** @com.method(vtoffset=36, dispid=16, type=PROPGET, name="MixedState", name2="getMixedState", addFlagsVtable=4)
      @com.parameters([type=BOOLEAN] return) */
  public native boolean getMixedState();
  ...
  public native void setMixedState(boolean pbMixedState);
  ...
  public static final com.ms.com._Guid clsid = new com.ms.com._Guid((int)0x713f354, (short)0x850a, (short)0x101b, (byte)0xaf, (byte)0xc0, (byte)0x42, (byte)0x10, (byte)0x10, (byte)0x2a, (byte)0x8d, (byte)0xa7);
}
