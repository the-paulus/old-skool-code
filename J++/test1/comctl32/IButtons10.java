...
// Dispatch-only interface IButtons10
/** @com.interface(iid=0713E451-850A-101B-AFC0-4210102A8DA7, thread=AUTO, type=DISPATCH) */
public interface IButtons10 extends IUnknown
{
  ...
  /** @com.method(dispid=0, type=PROPGET, name="ControlDefault", name2="getControlDefault", returntype=VOID)
      ...
      @hidden */
  public comctl32.Button getControlDefault(Variant Index);
  ...
  /** @com.method(dispid=0, type=PROPPUT, name="ControlDefault", name2="putControlDefault", returntype=VOID)
      ...
      @hidden */
  public void setControlDefault(Variant Index, comctl32.Button _jcomparam_1);

  /** @com.method(dispid=2, type=PROPGET, name="Item", name2="getItem", returntype=VOID)
      @com.parameters([in,elementType=VARIANT,type=PTR] Index, [type=OBJECT] return) */
  public comctl32.Button getItem(Variant Index);

  /** @com.method(dispid=2, type=PROPPUT, name="Item", name2="putItem", returntype=VOID)
      @com.parameters([in,elementType=VARIANT,type=PTR] Index, [in,type=OBJECT] _jcomparam_1) */
  public void setItem(Variant Index, comctl32.Button _jcomparam_1);
  ...
  /** @com.method(dispid=5, type=METHOD, name="Add", returntype=VOID)
      @com.parameters([in,elementType=VARIANT,type=PTR] Index, [in,elementType=VARIANT,type=PTR] Key, [in,elementType=VARIANT,type=PTR] Caption, [in,elementType=VARIANT,type=PTR] Style, [in,elementType=VARIANT,type=PTR] Image, [type=OBJECT] return) */
  public comctl32.Button Add(Variant Index, Variant Key, Variant Caption, Variant Style, Variant Image);
  ...
  public static final com.ms.com._Guid iid = new com.ms.com._Guid((int)0x713e451, (short)0x850a, (short)0x101b, (byte)0xaf, (byte)0xc0, (byte)0x42, (byte)0x10, (byte)0x10, (byte)0x2a, (byte)0x8d, (byte)0xa7);
}
