...
// Dispatch-only interface IListItems10
/** @com.interface(iid=0713E8AE-850A-101B-AFC0-4210102A8DA7, thread=AUTO, type=DISPATCH) */
public interface IListItems10 extends IUnknown
{
  ...
  /** @com.method(dispid=0, type=PROPGET, name="ControlDefault", name2="getControlDefault", returntype=VOID)
      ...
      @hidden */
  public comctl32.ListItem getControlDefault(Variant Index);
  ...
  /** @com.method(dispid=0, type=PROPPUT, name="ControlDefault", name2="putControlDefault", returntype=VOID)
      ...
      @hidden */
  public void setControlDefault(Variant Index, comctl32.ListItem _jcomparam_1);

  /** @com.method(dispid=2, type=METHOD, name="Add", returntype=VOID)
      @com.parameters([in,elementType=VARIANT,type=PTR] Index, [in,elementType=VARIANT,type=PTR] Key, [in,elementType=VARIANT,type=PTR] Text, [in,elementType=VARIANT,type=PTR] Icon, [in,elementType=VARIANT,type=PTR] SmallIcon, [type=OBJECT] return) */
  public comctl32.ListItem Add(Variant Index, Variant Key, Variant Text, Variant Icon, Variant SmallIcon);
  ...
  /** @com.method(dispid=4, type=PROPGET, name="Item", name2="getItem", returntype=VOID)
      @com.parameters([in,elementType=VARIANT,type=PTR] Index, [type=OBJECT] return) */
  public comctl32.ListItem getItem(Variant Index);

  /** @com.method(dispid=4, type=PROPPUT, name="Item", name2="putItem", returntype=VOID)
      @com.parameters([in,elementType=VARIANT,type=PTR] Index, [in,type=OBJECT] _jcomparam_1) */
  public void setItem(Variant Index, comctl32.ListItem _jcomparam_1);
  ...
  public static final com.ms.com._Guid iid = new com.ms.com._Guid((int)0x713e8ae, (short)0x850a, (short)0x101b, (byte)0xaf, (byte)0xc0, (byte)0x42, (byte)0x10, (byte)0x10, (byte)0x2a, (byte)0x8d, (byte)0xa7);
}
