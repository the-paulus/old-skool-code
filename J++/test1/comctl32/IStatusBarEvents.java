...
// Dispatch-only interface IStatusBarEvents
/** @com.interface(iid=6B7E6391-850A-101B-AFC0-4210102A8DA7, thread=AUTO, type=DISPATCH) */
public interface IStatusBarEvents extends IUnknown
{
  /** @com.method(dispid=1, type=METHOD, name="PanelClick", returntype=VOID)
      @com.parameters([in,type=OBJECT] Panel) */
  public void PanelClick(comctl32.Panel Panel);

  /** @com.method(dispid=2, type=METHOD, name="PanelDblClick", returntype=VOID)
      @com.parameters([in,type=OBJECT] Panel) */
  ...
  public static final com.ms.com._Guid iid = new com.ms.com._Guid((int)0x6b7e6391, (short)0x850a, (short)0x101b, (byte)0xaf, (byte)0xc0, (byte)0x42, (byte)0x10, (byte)0x10, (byte)0x2a, (byte)0x8d, (byte)0xa7);
}
