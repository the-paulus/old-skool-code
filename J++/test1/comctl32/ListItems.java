...
/** @com.class(classid=0713E8C4-850A-101B-AFC0-4210102A8DA7,DynamicCasts) 
    @com.interface(iid=F4D83601-895E-11D0-B0A6-000000000000, thread=AUTO, type=DUAL) */
public class ListItems implements IUnknown,com.ms.com.NoAutoScripting,comctl32.IListItems
{
  ...
  /** @com.method(vtoffset=6, dispid=0, type=PROPGET, name="ControlDefault", name2="getControlDefault", addFlagsVtable=4)
      ...
      @hidden */
  public native comctl32.IListItem getControlDefault(Variant Index);
  ...
  public native comctl32.IListItem Add(Variant Index, Variant Key, Variant Text, Variant Icon, Variant SmallIcon);
  ...
  /** @com.method(vtoffset=9, dispid=4, type=PROPGET, name="Item", name2="getItem", addFlagsVtable=4)
      @com.parameters([in,elementType=VARIANT,type=PTR] Index, [iid=F4D83602-895E-11D0-B0A6-000000000000,thread=AUTO,type=DISPATCH] return) */
  public native comctl32.IListItem getItem(Variant Index);
  ...
  public static final com.ms.com._Guid clsid = new com.ms.com._Guid((int)0x713e8c4, (short)0x850a, (short)0x101b, (byte)0xaf, (byte)0xc0, (byte)0x42, (byte)0x10, (byte)0x10, (byte)0x2a, (byte)0x8d, (byte)0xa7);
}
