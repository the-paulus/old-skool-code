...
// Dispatch-only interface ProgressBarEventMulticaster
class ProgressBarEventMulticaster implements comctl32.IProgressBarEvents, com.ms.com.NoAutoScripting, com.ms.com.NoAutoMarshaling
{
  comctl32.ProgressBar.ProgressBar _jcom_parent;

  ProgressBarEventMulticaster( comctl32.ProgressBar.ProgressBar _jcom_parent )
  {
  ...
  public void OLEStartDrag(comctl32.DataObject[] Data, int[] AllowedEffects)
  {
     if( _jcom_parent.onOLEStartDrag != null) {
        _jcom_parent.onOLEStartDrag.invoke( _jcom_parent, new comctl32.ProgressBar.OLEStartDragEvent( Data, AllowedEffects ) );
     }
  }
  ...
  public void OLEGiveFeedback(int[] Effect, boolean[] DefaultCursors)
  {
     if( _jcom_parent.onOLEGiveFeedback != null) {
        _jcom_parent.onOLEGiveFeedback.invoke( _jcom_parent, new comctl32.ProgressBar.OLEGiveFeedbackEvent( Effect, DefaultCursors ) );
     }
  }
  ...
  public void OLESetData(comctl32.DataObject[] Data, short[] DataFormat)
  {
     if( _jcom_parent.onOLESetData != null) {
        _jcom_parent.onOLESetData.invoke( _jcom_parent, new comctl32.ProgressBar.OLESetDataEvent( Data, DataFormat ) );
     }
  }
  ...
  public void OLECompleteDrag(int[] Effect)
  {
     if( _jcom_parent.onOLECompleteDrag != null) {
        _jcom_parent.onOLECompleteDrag.invoke( _jcom_parent, new comctl32.ProgressBar.OLECompleteDragEvent( Effect ) );
     }
  }
  ...
  public void OLEDragOver(comctl32.DataObject[] Data, int[] Effect, short[] Button, short[] Shift, float[] x, float[] y, short[] State)
  {
     if( _jcom_parent.onOLEDragOver != null) {
        _jcom_parent.onOLEDragOver.invoke( _jcom_parent, new comctl32.ProgressBar.OLEDragOverEvent( Data, Effect, Button, Shift, x, y, State ) );
     }
  }
  ...
  public void OLEDragDrop(comctl32.DataObject[] Data, int[] Effect, short[] Button, short[] Shift, float[] x, float[] y)
  {
     if( _jcom_parent.onOLEDragDrop != null) {
        _jcom_parent.onOLEDragDrop.invoke( _jcom_parent, new comctl32.ProgressBar.OLEDragDropEvent( Data, Effect, Button, Shift, x, y ) );
     }
  }
