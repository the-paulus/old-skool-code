...
/** @com.class(classid=6B7E638F-850A-101B-AFC0-4210102A8DA7,DynamicCasts) 
    @com.interface(iid=E6E17E88-DF38-11CF-8E74-00A0C90F26F8, thread=AUTO, type=DUAL) */
public class StatusBarRaw implements IUnknown,com.ms.com.NoAutoScripting,comctl32.IStatusBar
{
  /** @com.method(vtoffset=4, dispid=1, type=PROPGET, name="SimpleText", name2="getSimpleText", addFlagsVtable=4)
      @com.parameters([type=STRING] return) */
  public native String getSimpleText();
  ...
  public native void setSimpleText(String pbstrSimpleText);
  ...
  public native comctl32.IPanels getPanels();
  ...
  public native void setPanels(comctl32.IPanels ppPanels);
  ...
  /** @com.method(vtoffset=17, dispid=6, type=PROPGET, name="PanelProperties", name2="getPanelProperties", addFlagsVtable=4)
      @com.parameters([type=STRING] return)
      @hidden */
  public native String getPanelProperties();
  ...
  /** @com.method(vtoffset=18, dispid=6, type=PROPPUT, name="PanelProperties", name2="putPanelProperties", addFlagsVtable=4)
      ...
      @hidden */
  public native void setPanelProperties(String pbstrPanelProperties);
  ...
  public static final com.ms.com._Guid clsid = new com.ms.com._Guid((int)0x6b7e638f, (short)0x850a, (short)0x101b, (byte)0xaf, (byte)0xc0, (byte)0x42, (byte)0x10, (byte)0x10, (byte)0x2a, (byte)0x8d, (byte)0xa7);
}
