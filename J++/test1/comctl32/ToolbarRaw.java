...
/** @com.class(classid=612A8624-0FB3-11CE-8747-524153480004,DynamicCasts) 
    @com.interface(iid=E6E17E8C-DF38-11CF-8E74-00A0C90F26F8, thread=AUTO, type=DUAL) */
public class ToolbarRaw implements IUnknown,com.ms.com.NoAutoScripting,comctl32.IToolbar
{
  ...
  public native boolean getAllowCustomize();
  ...
  public native void setAllowCustomize(boolean pbAllowCustomize);
  ...
  public native comctl32.IButtons getButtons();
  ...
  public native void setButtons(comctl32.IButtons ppButtons);
  ...
  public native comctl32.IControls getControls();
  ...
  public native void setShowTips(boolean bShowTips);
  ...
  /** @com.method(vtoffset=27, dispid=7, type=PROPGET, name="Wrappable", name2="getWrappable", addFlagsVtable=4)
      @com.parameters([type=BOOLEAN] return) */
  public native boolean getWrappable();
  ...
  public native void setWrappable(boolean pbWrappable);
  ...
  public native float getButtonHeight();
  ...
  public native void setButtonWidth(float pfButtonWidth);
  ...
  public native void setHelpContextID(int plHelpContextID);
  ...
  public native void setHelpFile(String pbstrHelpFile);
  ...
  public native void SaveToolbar(String Key, String Subkey, String Value);

  /** @com.method(vtoffset=42, dispid=12, type=METHOD, name="RestoreToolbar", addFlagsVtable=4)
      @com.parameters([in,type=STRING] Key, [in,type=STRING] Subkey, [in,type=STRING] Value) */
  public native void RestoreToolbar(String Key, String Subkey, String Value);
  ...
  public static final com.ms.com._Guid clsid = new com.ms.com._Guid((int)0x612a8624, (short)0xfb3, (short)0x11ce, (byte)0x87, (byte)0x47, (byte)0x52, (byte)0x41, (byte)0x53, (byte)0x48, (byte)0x0, (byte)0x4);
}
