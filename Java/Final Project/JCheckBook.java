...
class JCheckPane extends JPanel implements ActionListener
{
    ...
    */
    ...
    {
    	balance = bal;
        lblBalance.setText("Balance is: " + bal);
    }
...
public class JCheckBook extends JFrame implements ActionListener, IDocument
{
            ...
            try 
            {
		        ...
		        JOptionPane.showMessageDialog(this, "This is not a valid file.", "Error", JOptionPane.ERROR_MESSAGE);
                    ...
                    if(s.indexOf("BALANCE") > 0)
                    {
                        ...
                        jp.setBalance(String.copyValueOf(s.toCharArray(), index, len));
                    }   
	            String s2[];
