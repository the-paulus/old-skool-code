...
public interface IListView extends IUnknown
{
  ...
  public comctl32.IColumnHeaders getColumnHeaders();
  ...
  public void setColumnHeaders(comctl32.IColumnHeaders ppIColumnHeaders);
  ...
  public comctl32.IListItem getDropHighlight();
  ...
  public void setDropHighlight(comctl32.IListItem ppIListItem);
  ...
  public void setDropHighlight(Variant ppIListItem);
  ...
  public comctl32.IListItems getListItems();
  ...
  public void setListItems(comctl32.IListItems ppListItems);
  ...
  /** @com.method(vtoffset=31, dispid=13, type=PROPGET, name="SelectedItem", name2="getSelectedItem", addFlagsVtable=4)
      @com.parameters([iid=F4D83602-895E-11D0-B0A6-000000000000,thread=AUTO,type=DISPATCH] return) */
  public comctl32.IListItem getSelectedItem();
  ...
  public void setSelectedItem(comctl32.IListItem ppListItem);
  ...
  public void setSelectedItem(Variant ppListItem);
  ...
  public comctl32.IListItem FindItem(String sz, Variant Where, Variant Index, Variant fPartial);

  /** @com.method(vtoffset=64, dispid=20, type=METHOD, name="GetFirstVisible", addFlagsVtable=4)
      @com.parameters([iid=F4D83602-895E-11D0-B0A6-000000000000,thread=AUTO,type=DISPATCH] return) */
  public comctl32.IListItem GetFirstVisible();
  ...
  public comctl32.IListItem HitTest(float x, float y);
