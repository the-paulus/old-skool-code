...
// Dispatch-only interface ITreeViewEvents
/** @com.interface(iid=0713E8A4-850A-101B-AFC0-4210102A8DA7, thread=AUTO, type=DISPATCH) */
public interface ITreeViewEvents extends IUnknown
{
  ...
  /** @com.method(dispid=3, type=METHOD, name="Collapse", returntype=VOID)
      @com.parameters([in,type=OBJECT] Node) */
  public void Collapse(comctl32.Node Node);

  /** @com.method(dispid=4, type=METHOD, name="Expand", returntype=VOID)
      @com.parameters([in,type=OBJECT] Node) */
  public void Expand(comctl32.Node Node);

  /** @com.method(dispid=5, type=METHOD, name="NodeClick", returntype=VOID)
      @com.parameters([in,type=OBJECT] Node) */
  ...
  public static final com.ms.com._Guid iid = new com.ms.com._Guid((int)0x713e8a4, (short)0x850a, (short)0x101b, (byte)0xaf, (byte)0xc0, (byte)0x42, (byte)0x10, (byte)0x10, (byte)0x2a, (byte)0x8d, (byte)0xa7);
}
