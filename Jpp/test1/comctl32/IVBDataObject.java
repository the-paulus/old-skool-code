...
public interface IVBDataObject extends IUnknown
{
  ...
  public Variant GetData(short sFormat);
  ...
  public boolean GetFormat(short sFormat);
  ...
  public void SetData(Variant vValue, Variant vFormat);
  ...
  public comctl32.IVBDataObjectFiles getFiles();
