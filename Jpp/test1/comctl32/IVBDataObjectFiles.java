...
public interface IVBDataObjectFiles extends IUnknown
{
  ...
  public String getItem(int lIndex);
  ...
  public void Add(String bstrFilename, Variant vIndex);
  ...
  public void Remove(Variant vIndex);
