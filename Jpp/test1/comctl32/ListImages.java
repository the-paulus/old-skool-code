...
/** @com.class(classid=0713E8C2-850A-101B-AFC0-4210102A8DA7,DynamicCasts) 
    @com.interface(iid=8556BCD0-E01E-11CF-8E74-00A0C90F26F8, thread=AUTO, type=DUAL) */
public class ListImages implements IUnknown,com.ms.com.NoAutoScripting,comctl32.IImages
{
  ...
  /** @com.method(vtoffset=6, dispid=0, type=PROPGET, name="ControlDefault", name2="getControlDefault", addFlagsVtable=4)
      ...
      @hidden */
  public native comctl32.IImage getControlDefault(Variant Index);
  ...
  /** @com.method(vtoffset=7, dispid=0, type=PROPPUTREF, name="ControlDefault", name2="putControlDefault", addFlagsVtable=4)
      ...
      @hidden */
  public native void setControlDefault(Variant Index, comctl32.IImage ppListImage);
  ...
  public native comctl32.IImage Add(Variant Index, Variant Key, Variant Picture);
  ...
  /** @com.method(vtoffset=10, dispid=4, type=PROPGET, name="Item", name2="getItem", addFlagsVtable=4)
      @com.parameters([in,elementType=VARIANT,type=PTR] Index, [iid=8556BCD2-E01E-11CF-8E74-00A0C90F26F8,thread=AUTO,type=DISPATCH] return) */
  public native comctl32.IImage getItem(Variant Index);
  ...
  public native void setItem(Variant Index, comctl32.IImage Item);
  ...
  public static final com.ms.com._Guid clsid = new com.ms.com._Guid((int)0x713e8c2, (short)0x850a, (short)0x101b, (byte)0xaf, (byte)0xc0, (byte)0x42, (byte)0x10, (byte)0x10, (byte)0x2a, (byte)0x8d, (byte)0xa7);
}
