...
/** @com.class(classid=373FF7F0-EB8B-11CD-8820-08002B2F4F5A,DynamicCasts) 
    @com.interface(iid=E6E17E86-DF38-11CF-8E74-00A0C90F26F8, thread=AUTO, type=DUAL) */
public class SliderRaw implements IUnknown,com.ms.com.NoAutoScripting,comctl32.ISlider
{
  ...
  public native void setSmallChange(int plSmallChange);
  ...
  public native void setMax(int plMax);
  ...
  public native void setMin(int plMin);
  ...
  public native void setSelectRange(boolean pbSelectRange);
  ...
  public native void setSelStart(int plSelStart);
  ...
  public native void setTickFrequency(int plTickFrequency);
  ...
  /** @com.method(vtoffset=27, dispid=11, type=PROPPUT, name="Value", name2="putValue", addFlagsVtable=4)
      @com.parameters([in,type=I4] plValue) */
  public native void setValue(int plValue);
  ...
  public static final com.ms.com._Guid clsid = new com.ms.com._Guid((int)0x373ff7f0, (short)0xeb8b, (short)0x11cd, (byte)0x88, (byte)0x20, (byte)0x8, (byte)0x0, (byte)0x2b, (byte)0x2f, (byte)0x4f, (byte)0x5a);
}
