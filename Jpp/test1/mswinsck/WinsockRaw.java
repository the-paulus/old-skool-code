...
/** @com.class(classid=248DD896-BB45-11CF-9ABC-0080C7E7B78D,DynamicCasts) 
    @com.interface(iid=248DD892-BB45-11CF-9ABC-0080C7E7B78D, thread=AUTO, type=DUAL) */
public class WinsockRaw implements IUnknown,com.ms.com.NoAutoScripting,mswinsck.IMSWinsockControl
{
  ...
  /** @com.method(vtoffset=12, dispid=0, type=PROPPUT, name="_RemoteHost", name2="put_RemoteHost", addFlagsVtable=4)
      ...
      @hidden */
  public native void set_RemoteHost(String RemoteHost);
  ...
  public native void Connect(Variant RemoteHost, Variant RemotePort);
  ...
  public native void GetData(Variant data, Variant type, Variant maxLen);

  /** @com.method(vtoffset=24, dispid=69, type=METHOD, name="PeekData", addFlagsVtable=4)
      @com.parameters([in,out,elementType=VARIANT,type=PTR] data, [in,type=VARIANT] type, [in,type=VARIANT] maxLen) */
  public native void PeekData(Variant data, Variant type, Variant maxLen);
  ...
  public native void Bind(Variant LocalPort, Variant LocalIP);
  ...
  /** @com.method(vtoffset=28, dispid=10, type=PROPPUT, name="RemoteHost", name2="putRemoteHost", addFlagsVtable=4)
      @com.parameters([in,type=STRING] RemoteHost) */
  public native void setRemoteHost(String RemoteHost);
  ...
  public static final com.ms.com._Guid clsid = new com.ms.com._Guid((int)0x248dd896, (short)0xbb45, (short)0x11cf, (byte)0x9a, (byte)0xbc, (byte)0x0, (byte)0x80, (byte)0xc7, (byte)0xe7, (byte)0xb7, (byte)0x8d);
}
